...
var productContainer = document.getElementById("product-container1"); // Tham chiếu đến phần tử hiển thị sản phẩm
...
function createPaginationButtons() {
    ...
    var paginationContainer = document.getElementById("pagination1");
